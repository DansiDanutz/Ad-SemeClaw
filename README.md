...
5. **Auth** — Supabase JS 2.110.8 is version-pinned and SHA-384 integrity-checked; OAuth returns to `/advertiser`, every same-origin advertiser API request carries the current session JWT, and missing server auth configuration fails closed.
